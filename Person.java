public class Person {
    ...
    //setter and getter for birthyear
                public int setBirthYear(int pintBirthYear) {
    ...
    //birth month setter and getter 
                public int setBirthMonth(int pintBirthMonth){
    ...
    //birthday setter and getter 
                public int setBirthDay(int pintBirthDay){
...
//setters and getters for gender and characteristics of individual
    ...
    //gender
                public char setchrGender(char pchrGender){
    ...
    //intHeightIN setter and getters 
                public int setintHeightIN(int pintHeightIN){
    ...
    //intWeightLBS setter and getter
                public int setintWeightLBS(int pintWeightLBS){
